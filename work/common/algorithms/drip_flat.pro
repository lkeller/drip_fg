...
;
; CALLING SEQUENCE:
;       FLATTED=DRIP_FLAT(DATA,MASTERFLAT,BASEHEAD=BASEHEAD)
;
; INPUTS:
...
function drip_flat, data, masterflat, darksum, basehead=basehead
...
endelse
;drip_message, 'drip_flat - Spectral FLATFIELD APPLIED for defringing'
return, flatted
end
