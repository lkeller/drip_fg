...
sxaddpar,basehead,'HISTORY','Pixel-to-pixel non-linearity was not applied'
return,data
...
if sc[0] gt 2 then begin 
    ...
    drip_message, 'WARNING: pixel-to-pixel linearity correction is not yet available'
    sxaddpar,basehead,'HISTORY','Pixel-to-pixel non-linearity was not applied (Invalid Coefficients)'
    linearized=data
endelse
