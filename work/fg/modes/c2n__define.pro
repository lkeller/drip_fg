...
;
; PURPOSE:
;     Data Reduction Pipeline for GRISM c2n mode
;
; CALLING SEQUENCE:
...
;     Modified:  Luke Keller, Ithaca College, May 2012
;                Modified GRISM stare mode --> GRISM c2n mode
...
*self.extracted=drip_spextract(*self.undistorted, *self.basehead, self.gmode) ;header
...
;o=(mode eq 1) ? 'on' : 'off'
o=''
self.readme=['pipeline: Grism C2N Mode ' + o + ' chip DRiP', $ ;info lines
  'file: ' + self.filename, $
  'final image: undistorted', $
  'order: CLEAN, FLAT, STACK, COADD', $
  'notes: badmap from CLEAN, masterflat from FLAT']

; print,'Grism C2N Mode FINISHED',self.n ;info

end

;******************************************************************************
;     C2N__DEFINE - Define the STARE class structure.
;******************************************************************************
