...
label=widget_label(self.topwid, value='Pipe Step:', font=largefont, /dynamic_resize)
button_tv=widget_button(self.topwid, value='ATV' , /dynamic_resize)
...
function drip_analman_select::init, baseid, FG=FG
