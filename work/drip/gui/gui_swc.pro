...
;     GUI - Main function
;******************************************************************************
pro gui_swc, xsize=xs, ysize=ys, dataman=dataman_return, _extra=e
...
if (size(findfile(currentdir+path_sep()+'guiconf.txt')))[0] eq 1 then begin
    ...
    conffilename=dialog_pickfile(/must_exist,/read,title='Load SWC GUI Conf File:')
endelse
...
; base widget
top=widget_base(column=2, title='FORCAST SWC Quick Look Data Reduction', $
