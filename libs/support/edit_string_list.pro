...
if not keyword_set(viewonly) then $ ; [Cancel]
  cancelwid=widget_button(button_list, value='Cancel', uvalue=0, $
                           event_pro='edit_string_list_event') $
  else cancelwid=0
