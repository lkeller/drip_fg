pro custom_fitsdir, file_names, keyvalue, directory, TEXTOUT = textout, Keywords = keywords, $ 
...
;       Assume since V5.5, file_search() available W. Landsman Aug
;       2006
;       Calling sequence modified for drip 2.0, L. Keller Nov 2012
;-
 On_error,2
