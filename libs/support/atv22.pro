...
;                {cw_pdmenu_s, 2, ' FIRST'}, $
                ...
                {cw_pdmenu_s, 0, 'InvertPixData'}, $ ; IPT
                {cw_pdmenu_s, 0, '--------------'}, $
...
main_image*=(-1) ; Invert pixel data of displayed image
min_value=state.min_value
max_value=state.max_value
;state.min_value=max_value*(-1)
;state.max_value=min_value*(-1)
;atv_set_minmax
atv_displayall

print, 'Display image pix values inverted'
